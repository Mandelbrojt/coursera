...
ggsave("lineplot.jpg",plot=line_plot, path = "/Users/luism/Documents/R/ggplot-data-vis/sample codes/week 3")
ggsave("lineplot.pdf",plot=line_plot, path = "/Users/luism/Documents/R/ggplot-data-vis/sample codes/week 3")

#####to save files as .svg from ggsave
#install.packages("svglite")
library(svglite)

ggsave("lineplot.svg",plot=line_plot, path = "/Users/luism/Documents/R/ggplot-data-vis/sample codes/week 3")
